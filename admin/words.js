systemDictionary = {
    ...
    "DB settings:":         {"en": "DB settings:",          "de": "DB Einstellungen:",              "ru": "Настройки DB:"},
    "DB Type":              {"en": "DB Type",               "de": "DB Typ",                         "ru": "Тип DB"},
    "DB Name":              {"en": "DB Name",               "de": "DB Name",                        "ru": "Имя DB"},
    ...
    "Buffer Datapoints":    {"en": "Buffer Datapoints",     "de": "Schreibaktionen sammeln",        "ru": "Собирать значения для записи"},
    ...
    "Buffer Flush Interval": {"en": "Buffer Flush Interval", "de": "Schreibintervall",              "ru": "Интервал записи значений"},
    "Seconds":              {"en": "Seconds",               "de": "Sekunden",                       "ru": "секунд"},
