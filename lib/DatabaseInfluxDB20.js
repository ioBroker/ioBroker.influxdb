...
const HealthAPI = require('@influxdata/influxdb-client-apis').HealthAPI;
...
/*            database: this.database,
    ...
    async queries(queries, callback) {    
        try {
            ...
            this.log.info("QUERY ERROR: " + JSON.stringify(error));
            callback(error, null);
        }
...
module.exports = {
    DatabaseInfluxDB20 : DatabaseInfluxDB20
  }