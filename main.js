...
function ping(adapter) {
    adapter._client.ping && adapter.config.pingserver && adapter._client.ping(adapter.config.pingInterval - 1000 < 0 ? 1000 : adapter.config.pingInterval - 1000)
        .then(
            hosts => {
